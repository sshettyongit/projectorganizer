...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <a class="navbar-brand h1 mainnav" href="{{ route('welcome.home') }}">PROJECTORGANIZER</a>
            ...
            <div class="d-inline-block nav1"> <a href="{{ route('admin.panel') }}" >BACK TO ADMIN</a> </div>
            </span>
        </div>
    </nav>
    <br><br><br>
    <div class="container">
        <form action="{{ route('edit.user',['$id' => $category->id]) }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1">EMAIL ADDRESS</label>
                <input type="email" class="form-control" id="exampleInputEmail1" name="email"  value="{{ $category->email}}">

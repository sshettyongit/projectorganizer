...
return [
    ...
    */
    ...
    'animate' => [
        'in_class'  => 'bounceInLeft', // The class to use to animate the notice in.
        'out_class' => 'bounceOutLeft', // The class to use to animate the notice out.
        'timeout'   => 3500, // Number of seconds before the notice disappears
    ],
